...
//    #include <Sipeed_ST7789.h>
    ...
    class M5Stack
    {
      public:
        ...
        // LCD
        SPIClass spi_ = SPIClass(SPI0); // MUST be SPI0 for Maix series on board LCD
//        Sipeed_ST7789 Lcd = Sipeed_ST7789(320, 240, spi_, SIPEED_ST7789_DCX_PIN, SIPEED_ST7789_RST_PIN, 3);
        Sipeed_Lcd Lcd = Sipeed_Lcd(320, 240, spi_, SIPEED_ST7789_DCX_PIN, SIPEED_ST7789_RST_PIN, 3);
